    ...
    <?php
        ...
        if(isset($_SESSION["id"])) {
            ...
            <section class="margin-inline margin-top-bottom">
                ...
                <form action="" method="POST" enctype="multipart/form-data" class="border border-black w-100">
                    <table class="align-middle table w-100">
                        <tr>
                            <td colspan="3">
                                <h4>Escolha uma imagem para ser capa do seu evento</h6>
                            <td colspan="100"><input class="form-control form-control-lg" type="file" name="image" accept="image/*" required /></td>
                            </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="100"><textarea class="form-control form-control-lg w-100" name="description" id="" cols="30" rows="10" required></textarea></td>
                        </tr>
                    </table>
                    <div>
            ...
            echo "<h2 class='text-center'>Faça <a href='login.php'>Login</a> para divulgar um evento</h2>";
        }
?>
